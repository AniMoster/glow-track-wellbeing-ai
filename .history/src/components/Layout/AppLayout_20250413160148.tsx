...
import { ActivityIcon, MoonIcon, HeartPulseIcon, UtensilsIcon, BookIcon, LayoutDashboardIcon, User2Icon, LogOutIcon, SettingsIcon } from 'lucide-react';
      ...
      <header className="bg-deep-dark-card border-b border-deep-dark-accent p-4 flex items-center justify-between">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56" align="end" forceMount>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="flex items-center" onClick={() => navigate('/settings')}>
